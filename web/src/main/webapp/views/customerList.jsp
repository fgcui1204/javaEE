        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/web/customers">顾客管理</a></li>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach items="${customers}" var="customer">
            <tr>
                ...
                <td><a href="/web/customers/delete/${customer.id}">删除</a></td>
                <td><a href="/web/customers/update/${customer.id}">修改</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    <a href="/web/customers/create">添加顾客</a>
</div>
</body>
</html>
